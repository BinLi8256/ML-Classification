...
```
<br>
(2) **Prediction**: Random forest model, **rf.opt**, is used to predict y for the test set. The classification decision is based on the optimal threshold, **0.3795**, obtained from ROC. Finally, the prediction result with filename is saved as a csv file, **test_prediction**.  
<br>
```{r}
# Predict 
